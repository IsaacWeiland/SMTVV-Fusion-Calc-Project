...
public class DemonController : Controller
{
    ...
    public IActionResult CalculateResult(string input1, string input2)
    {
        ...
        // {
        //     var resultRace = _demonRepo.GetRace(demon1.Name, demon2.Race);
        // }
        // else if (demon2.Race == "Element")
        // {
        //     var resultRace = _demonRepo.GetRace(demon1.Race, demon2.Name);
        // }
        // else
        // {
            var resultRace = _demonRepo.GetRace(demon1.Race, demon2.Race);
        //}
        var resultDemon = _demonRepo.GetDemonResult(resultRace, resultLevel);
        if (resultDemon == null)
        {
